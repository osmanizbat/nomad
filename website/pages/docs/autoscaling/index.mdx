...
The process of automatically controlling the number of instances of an application
...
CPU and memory utilization or number of open connections.

## Horizontal Cluster Autoscaling

The process of adding or removing Nomad clients from a cluster to ensure there
...
clients based on metrics such as the remaining free schedulable CPU or memory.
